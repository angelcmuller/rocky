...
def add_cpin(classification, lat, lng, Mdate, Udate, author):
    ...
    document = {"Lattitude": lat, "Longitude": lng, "MeasurementDate": Mdate, "UploadDate": Udate, "Source": author, "Classification": classification}
