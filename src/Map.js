...
import { FaThumbsUp,FaThumbsDown,FaLocationArrow, FaCarAlt,FaTimes,FaCommentAlt, FaCalendar, FaCloud, FaEyeSlash, FaEye, FaBlind, FaServer} from 'react-icons/fa'
import './App.css'
import './Map.css'
...
import DOMPurify from 'dompurify';
  ...
  function Map() {
    ...
    const [pinDescription, setPinDesc] = useState(false);
          ...
          for (let i = 0; i < pinData.length; i++) {
            ...
            const marker = new mapboxgl.Marker({ color: markerColor })
              ...
              marker.getElement().addEventListener('click', () => {
                ShowPin(pinData[i].Classification);
    ...
    return (
      ...
      <Flex position= 'fixed' height = '100vh' w='100vw' display = 'vertical' color='white'>
        ...
        <HStack spacing = '0' > // space between map and description box 
          ...
          <HStack>
          <div
            dangerouslySetInnerHTML={{__html: pinDescription}}
          />
            <IconButton
                                  colorScheme='teal'
                                  aria-label='Call Segun'
