...
async function init_data(pinData, commentData){
  [pinData, commentData] = await Promise.all([MongoRecords(`http://localhost:3000/record/`)]);
  alert(pinData)
  displayMarkers(pinData, commentData);
}
