// traffic layer code from github and modified accordingly to fit the
// website needs and requirements. Link to the github is:
// https://github.com/mapbox/mapbox-gl-traffic
// Traffic layer worked on by Angel C. Muller
var trafficLayers = [
    {
